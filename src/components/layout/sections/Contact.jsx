    ...
    return (
        ...
        >
            ...
            <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-10">
                <div className="flex flex-col justify-center lg:items-center text-center gap-3" id="redes">
                    <h3 className="font-nourd text-xl text-bluesd">¿Estás listo para dar el primer paso?</h3>
