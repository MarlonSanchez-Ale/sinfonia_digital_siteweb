        ...
        <section id="services" className="flex flex-col gap-10 justify-center min-h-[90vh]  my-40">
            ...
            <div className="flex flex-col gap-20 mt-10">
                <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-5 md:place-items-center">
                    ...
                    <div className="flex flex-col justify-center place-items-start gap-2 text-start px-5">
                ...
                <div className="grid sm:grid-cols-1 md:grid-cols-2 md:place-items-center gap-5 ">
                    <div className="flex flex-col sm:order-last md:order-first justify-center gap-2 text-start ">
